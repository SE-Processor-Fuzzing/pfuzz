...
def count_differences(chrom_a, chrom_b):
...
class TestMutation(unittest.TestCase):
    ...
    def test_population_sort(self):
        ...
        self.assertEqual(sorted_population, [
            ({'gene1': '4'}, 0.7),
            ({'gene1': '2'}, 0.5)
        ])
...
class TestAssemblyMutation(unittest.TestCase):
    ...
    def test_find_labels_and_jumps(self):
    ...
    def test_assembly_crossover(self):
    ...
    def test_assembly_mutate(self):
        ...
        mutation_count = sum(
            1 for orig_line, mut_line in zip(original_content, child_content) 
